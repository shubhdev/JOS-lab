...
tarball: handin-check
	tar -zcf lab$(LAB)-handin.tar.gz kern/env.c kern/init.c kern/kdebug.c kern/pmap.c kern/syscall.c kern/trapentry.S kern/trap.c lib/libmain.c answers-lab3.txt
